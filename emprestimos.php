    ...
    <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Solicitar Empréstimo</strong>
                    </h2>
                    <hr>
					<br>
        
                
                <form method="POST" action="caddisp.php">
           ...
           <select DATE_FORMAT(d,m,y) as data;
            <td><label>Data para devolução <br><input type="date" id="dtdev" name="dtdev" value="" required></label><br><br></td></tr>
				
            <div class="botoes2">
                <tr> <td> <input class="cadastrar" type="submit" value="Emprestar" name="disp"/> </td>
				
        
				</form>
				<form class= "formulario" method="POST" enctype="multipart/form-data" action="caddisp.php">
				<td> 
